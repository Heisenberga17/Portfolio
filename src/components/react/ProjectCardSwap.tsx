    ...
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="flex items-center justify-center gap-4">
        <button
          ...
          className="w-10 h-10 shrink-0 rounded-full border border-border bg-bg-card flex items-center justify-center text-text-secondary transition-colors hover:border-accent-primary hover:text-accent-primary"
        ...
        <div
          ...
          style={{ width: 580 + 50 * 2, height: 460 }}
        >
          <CardSwap
            ref={swapRef}
            width={580}
